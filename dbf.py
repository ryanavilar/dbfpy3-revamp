...
__date__ = "$Date: 2020/05/21 09:23:13 $"[7:-2]
__author__ = "Jeff Kunce <kuncej@mail.conservation.state.mo.us>"
__revision_by__ = "Rifqi Ryan <ryanavilar@gmail.com>"
...
class Dbf(object):
    ...
    def isExist(self,header,value):
        try:
            return self.RecordClass.isExist(self,header,value)
        except Exception as e:
            raise e

    def findOne(self,header,value):
        try:
            return self.RecordClass.findOne(self,header,value)
        except Exception as e:
            raise e

    def findAll(self,header,value,option= None, getOnly = None):
        try:
            return self.RecordClass.findAll(self,header,value,option,getOnly)
        except Exception as e:
            raise e
